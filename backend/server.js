...
function buildAiSystemInstruction(message, isBuild, authContext = null) {
  ...
  const base = isBuild
    ...
    : [
        ...
        "في المحادثة العادية لا تعرض كوداً أو ملفات أو code fences من تلقاء نفسك. إذا طلب المستخدم بناء مشروع، وجّهه إلى زر Build ولا تحوّل المحادثة العادية إلى بناء فعلي. لا تعرض الكود إلا عندما يطلبه المستخدم بشكل مباشر وواضح.";
